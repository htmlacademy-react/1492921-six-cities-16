    ...
    <li className="reviews__item">
      <div className="reviews__user user">
        <div className="reviews__avatar-wrapper user__avatar-wrapper">
          <img className="reviews__avatar user__avatar" src={item.user.avatarUrl} width="54" height="54" alt="Reviews avatar"></img>
        </div>
      ...
      <div className="reviews__info">
        ...
        <time className="reviews__time" dateTime={item.date}>{(new Date(item.date)).toLocaleDateString('en-GB', {month: 'long', year: 'numeric'})}</time>
      </div>
    </li>
  );
}
